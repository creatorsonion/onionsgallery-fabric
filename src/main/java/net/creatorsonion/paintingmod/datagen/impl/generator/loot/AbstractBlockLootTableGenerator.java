...
import net.creatorsonion.paintingmod.datagen.impl.mixin.BlockLootTableGeneratorAccessor;
import net.creatorsonion.paintingmod.datagen.impl.mixin.BlockLootTableGeneratorInvoker;
