package net.creatorsonion.paintingmod.datagen.impl.generator.loot;

import com.google.common.collect.Sets;
import net.creatorsonion.paintingmod.datagen.impl.ObjectLootTableAccess;
import net.creatorsonion.paintingmod.datagen.impl.generator.AbstractGenerator;
...
public abstract class AbstractLootTableGenerator<T> extends AbstractGenerator<Identifier, LootTable.Builder> {
    ...
    public void accept(BiConsumer<Identifier, LootTable.Builder> biConsumer) {
        ...
        for (T obj : objects) {
            Identifier id = ((ObjectLootTableAccess) obj).getLootTableIdForDataGeneration();
        ...
        if (!this.map.isEmpty()) {
            throw new IllegalStateException(String.format("Created loot tables for non-%s: %s", registry.getKey().getValue().getPath(), this.map.keySet()));
        }
    }
    ...
    public void add(T obj, LootTable.Builder lootTable) {
        this.add(((ObjectLootTableAccess) obj).getLootTableIdForDataGeneration(), lootTable);
    }
