...
public class PMPaintingMotive extends PaintingMotive {
    ...
    public PMPaintingMotive(int width, int height) {
        super(width, height);
    }

    private static PaintingMotive register(String id, int width, int height) {
        return Registry.register(Registry.PAINTING_MOTIVE, new Identifier(PaintingMod.MOD_ID, id), new PMPaintingMotive(width, height));
    }
}
